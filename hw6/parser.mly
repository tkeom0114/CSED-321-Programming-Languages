...
term:
| appterm                       { $1 }         
| FUN VAR COLON tp ARROW term   { Tml.Lam ($2, $4, $6) }
;
...
| MATCH term WITH INL VAR ARROW term OR INR VAR ARROW term  { Tml.Case ($2, $5, $7, $10, $12) }  
| FIX VAR COLON tp ARROW term                               { Tml.Fix ($2, $4, $6) }
